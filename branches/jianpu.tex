...
\def\setdefaultul#1{\JP@defaultul=#1}
\def\ul#1{\JP@ul=#1\JP@nowpai=#1}
% special chars
\def\JP@makespecials{%
...
\JP@makenotecmd{\6}{6}
\JP@makenotecmd{\7}{7}
\def\JP@@equ{\advance\JP@nowpai by 1}
{
  \JP@makespecials
  \global\let\JP@caret=^
...
% environments
\def\melody{\begingroup\JP@makespecials\JP@mapspecials\JP@domyevery\JP@undospecials\@ifnextchar[{\JP@melodyparam}{\JP@melody}}
\def\JP@melodyparam[#1]{\JP@undospecials\JP@linewidth=#1\JP@m@lody}
\def\JP@melody{\JP@linewidth=\hsize\JP@m@lody}
\def\JP@m@lody#1\\{\hbox to \JP@linewidth{#1}\endgroup}

%\def\stk{}
%\let\push=\JP@push
%\let\pop=\JP@pop
%\let\setstack=\JP@setstack
%\setstack\stk{1234567890}
%\stk\par
%\push\stk3
%\push\stk4
%\stk
...
\newbox\tmpbox
\newbox\queue
\JP@resetqueuebox\queue
\setbox\tmpbox\hbox{Hello}
\JP@pushqueuebox\queue\tmpbox
\setbox\tmpbox\hbox{world}
\JP@pushqueuebox\queue\tmpbox
\copy\queue
\JP@popqueuebox\queue\tmpbox
\box\tmpbox
%\copy\queue
\JP@popqueuebox\queue\tmpbox
\box\tmpbox
